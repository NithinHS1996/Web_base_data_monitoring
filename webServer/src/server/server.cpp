...
SOCKET::CServer::CServer(int domain, int service, int protocal, int port, u_long interface, int backlog)
{
    socket = new CListeningSocket(domain, service, protocal, port, interface, backlog);
}

SOCKET::CListeningSocket *SOCKET::CServer::GetSocket()
{
    return socket;
}